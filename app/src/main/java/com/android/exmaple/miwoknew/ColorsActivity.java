...
public class ColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("mustard yellow","chiwes",R.drawable.color_mustard_yellow,R.raw.color_mustard_yellow));
        ...
        words.add(new Word("gray","totptpt",R.drawable.color_gray,R.raw.color_gray));
        words.add(new Word("black","kukoiu",R.drawable.color_black,R.raw.color_black));
