...
public class FamilyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("younger brother","chaliti",R.drawable.family_younger_brother,R.raw.family_younger_brother));
        ...
        words.add(new Word("grand father","api",R.drawable.family_grandfather,R.raw.family_grandfather));
